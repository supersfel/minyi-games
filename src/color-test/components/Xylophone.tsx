...
const Xylophone = memo(
  ({ colorAry, doCheckAnswer, answer, level, goNextLevel, gameEnd }: Props) => {
    ...
    }, [doCheckAnswer, answer, selected?.color]);
    ...
    useLayoutEffect(() => {
      ...
      return () => ctx.revert();
    }, [INTERVAL_BETWEEN, START_ROTATIONY, colorAry, doCheckAnswer]);
